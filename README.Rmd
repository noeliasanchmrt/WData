...
```{r, out.width = '50%', fig.width=4, fig.height=4, fig.align="center", fig.cap= "@sen1984 quantile estimator for shrub width."}
par(mfrow = c(1, 1))
...
```{r, out.width = '50%', fig.width=4, fig.height=4, fig.align="center", fig.cap= "Empirical quantile estimator for shrub width."}
par(mfrow = c(1, 1))
