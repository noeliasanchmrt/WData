...
Set of tools for analyzing and modeling data that may be
    ...
    functions, cumulative distribution functions, and quantiles from
    biased samples of a continuous distribution. Regarding density
    ...
    for @jones1991 density estimator, enhancing the flexibility and
    ...
    bandwidth selectors for the latter. For quantile function estimation,
    it provides two empirical estimators (one of which corresponds to
    @sen1984 proposal) and one kernel-type estimator. Additionally,
    for sparsity function estimation, the package includes the two
    estimators proposed by @akbari2019 (one plug-in and one
    kernel-type), as well as a third kernel-type estimator. Moreover, it
    offers functions for simulating datasets given a bias function and a
    reference distribution, providing users with the ability to generate
    synthetic datasets for various modeling and analysis purposes. It also
    includes functions for constructing boxplots and QQ plots for biased
    data, facilitating graphical exploration. Finally, the package
...
```{r,   fig.width=8, fig.height=8, fig.align="center", fig.cap= "@bose2022 distribution estimator for shrub width using local bandwiths."}
par(mfrow = c(2, 2))
...
```{r,  fig.width=12, fig.height=4, fig.align="center", fig.cap= "@bose2022 distribution estimator for shrub width using global bandwiths."}
par(mfrow = c(1, 3))
...
#### `cdf.efro()`: @efromovich2008 series distribution estimator 
...
```{r, out.width = '80%', fig.width=8, fig.height=4, fig.align="center", fig.cap= "Empirical quantile estimators for shrub width."}
par(mfrow = c(1, 2))
...
```{r,  fig.width=16, fig.height=4, fig.align="center", fig.cap= "Kernel quantile estimator for shrub width."}
par(mfrow = c(1, 4))
...
#### `sp.akbaripi()`: @akbari2019 plug-in sparsity estimator

```{r,  fig.width=16, fig.height=4, fig.align="center", fig.cap= "@akbari2019 plug-in sparsity estimator for shrub width."}
par(mfrow = c(1, 4))
...
```{r,  fig.width=16, fig.height=4, fig.align="center", fig.cap= "@akbari2019 kernel sparsity estimator for shrub width."}
par(mfrow = c(1, 4))
...
#### `sp.SBC()`: Kernel sparsity estimator based on @cox2005 distribution estimator

```{r,  fig.width=16, fig.height=4, fig.align="center", fig.cap= "kernel sparsity estimator based on @cox2005 distribution estimator for shrub width."}
par(mfrow = c(1, 4))
