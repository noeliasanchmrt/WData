...
#'
#' The parameter \eqn{C(y)} is provided to the function by using the argument `c_adj`, which is a vector of positive values that is used to compute the bandwidth for each point in `x`.
